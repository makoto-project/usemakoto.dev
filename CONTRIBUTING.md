...
Makoto is an Apache-2.0 open-source project. The protocol is still under review, so clear failure
reports, real data-system requirements, schema critiques, interoperability tests, documentation
fixes, and implementation patches are all useful contributions.
...
- [`makoto-project/usemakoto.dev`](https://github.com/makoto-project/usemakoto.dev) contains the
  public website and the checked mirror of schemas and demo evidence.
...
- Preserve the review-versus-release boundary. Do not describe the protocol as tagged, released,
  or fully conformant until those facts are independently true.
